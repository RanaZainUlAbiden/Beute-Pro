...
const PRODUCTS = [
     ...
     --------------------------------------------------------- */
  {
    ...
    en: {
      ...
      ingredients: ["Pure Aloe Vera Extract (Aloe Barbadensis Leaf Extract)", "Aqua", "Glycerine (Glycerolum)", "EDTA (Disodium EDTA)", "Vitamin B3 (Niacinamide)", "Hyaluronic Acid", "Rice Water"],
      benefits: ["Supports the production and release of collagen", "Can speed up wound healing time and limits scarring", "Has an antioxidant effect that can help repair sun damage & slow down the aging process", "Helps to make the skin more flexible and supple, rather than stiff and leathery"],
    ...
    ar: {
      ...
      ingredients: ["مستخلص الألوفيرا النقي", "ماء", "جليسرين", "إي دي تي إيه (EDTA)", "فيتامين B3 (نياسيناميد)", "حمض الهيالورونيك", "ماء الأرز"],
      benefits: ["يدعم إنتاج الكولاجين وإفرازه", "يسرّع وقت التئام الجروح ويقلل التندّب", "له تأثير مضاد للأكسدة يساعد على إصلاح أضرار الشمس وإبطاء الشيخوخة", "يساعد على جعل البشرة أكثر مرونة ونعومة بدلًا من الجفاف والتصلّب"],
...

  {
    ...
    en: {
      ...
      ingredients: ["Pure Cucumber Extract (Cucumis Sativus Fruit Extract)", "Aqua", "Glycerine (Glycerolum)", "EDTA (Disodium EDTA)", "Vitamin B3 (Niacinamide)", "Hyaluronic Acid", "Rice Water"],
      benefits: ["Calming and anti-inflammatory properties that help soothe blemishes and minor skin irritations", "Mildly astringent — balances oil production and reduces the appearance of age spots, freckles & pores", "Tones and tightens skin for anti-aging benefits", "Cooling properties, perfect for reducing puffiness and soothing sunburn or acne irritation"],
      usage: "Spray 2-3 times evenly across the face and neck, any time during the day, to refresh and moisturize the skin. Can be used for instant hydration, as a toner, or as a primer before or to set makeup."
    },
    ar: {
      ...
      ingredients: ["مستخلص الخيار النقي", "ماء", "جليسرين", "إي دي تي إيه (EDTA)", "فيتامين B3 (نياسيناميد)", "حمض الهيالورونيك", "ماء الأرز"],
      benefits: ["خصائص مهدئة ومضادة للالتهاب تساعد على تهدئة البثور وتهيجات البشرة البسيطة", "قابض خفيف يوازن إفراز الزيوت ويقلل ظهور البقع الداكنة والنمش والمسام", "ينعّم البشرة ويشدّها لفوائد مضادة للشيخوخة", "خصائص مبرّدة، مثالية لتقليل الانتفاخ وتهدئة حروق الشمس أو تهيج حب الشباب"],
      usage: "رشّي 2-3 مرات بالتساوي على الوجه والرقبة في أي وقت من اليوم لتنعش البشرة وترطبها. يمكن استخدامه للترطيب الفوري، كتونر، أو كبرايمر قبل المكياج أو لتثبيته."
    }
  },

  {
    ...
    en: {
      ...
      ingredients: ["Pure Neem Hydrosol (Azadirachta Indica)", "Aqua", "Glycerine (Glycerolum)", "EDTA (Disodium EDTA)", "Vitamin B3 (Niacinamide)", "Hyaluronic Acid", "Rice Water"],
      benefits: ["Helps dry skin, pimples, rashes & zits, and could be used for all skin types"],
      usage: "Spray 2-3 times evenly across the face and neck, any time during the day, to refresh and moisturize the skin. Can be used for instant hydration, as a toner, or as a primer before or to set makeup."
    },
    ar: {
      ...
      ingredients: ["مقطر النيم النقي", "ماء", "جليسرين", "إي دي تي إيه (EDTA)", "فيتامين B3 (نياسيناميد)", "حمض الهيالورونيك", "ماء الأرز"],
      benefits: ["يساعد على تهدئة البشرة الجافة وحب الشباب والطفح الجلدي والبثور، ويمكن استخدامه لجميع أنواع البشرة"],
      usage: "رشّي 2-3 مرات بالتساوي على الوجه والرقبة في أي وقت من اليوم لتنعش البشرة وترطبها. يمكن استخدامه للترطيب الفوري، كتونر، أو كبرايمر قبل المكياج أو لتثبيته."
    }
  },

  {
    ...
    en: {
      ...
      ingredients: ["Pure Lemon Extract (Citrus Limon Fruit Extract)", "Aqua", "Glycerine (Glycerolum)", "EDTA (Disodium EDTA)", "Vitamin B3 (Niacinamide)", "Hyaluronic Acid", "Rice Water"],
      benefits: ["Removes excess oil buildup from facial skin", "Balances skin pH levels", "Refreshes and brightens skin with energizing lemon", "Helps with sunburns, brightens skin, reduces blemishes and acne-scars, removes dirt from pores", "Antibacterial, antioxidant, natural antiseptic properties"],
      usage: "Spray 2-3 times evenly across the face and neck, any time during the day, to refresh and moisturize the skin. Can be used for instant hydration, as a toner, or as a primer before or to set makeup."
    },
    ar: {
      ...
      ingredients: ["مستخلص الليمون النقي", "ماء", "جليسرين", "إي دي تي إيه (EDTA)", "فيتامين B3 (نياسيناميد)", "حمض الهيالورونيك", "ماء الأرز"],
      benefits: ["يزيل تراكم الزيوت الزائدة من بشرة الوجه", "يوازن مستويات حموضة البشرة", "ينعش البشرة ويضيء مظهرها بفضل طاقة الليمون", "يساعد على تهدئة حروق الشمس، وتفتيح البشرة، وتقليل البقع وآثار حب الشباب، وتنظيف المسام", "خصائص مضادة للبكتيريا ومضادة للأكسدة ومطهرة طبيعية"],
      usage: "رشّي 2-3 مرات بالتساوي على الوجه والرقبة في أي وقت من اليوم لتنعش البشرة وترطبها. يمكن استخدامه للترطيب الفوري، كتونر، أو كبرايمر قبل المكياج أو لتثبيته."
    }
  },

  {
    ...
    en: {
      ...
      ingredients: ["Rose Floral Water (Rosa Damascena)", "Aqua", "Glycerine (Glycerolum)", "EDTA (Disodium EDTA)", "Vitamin B3 (Niacinamide)", "Hyaluronic Acid", "Rice Water"],
      benefits: ["Helps dry skin, pimples, rashes & zits, and could be used for all skin types"],
      usage: "Spray 2-3 times evenly across the face and neck, any time during the day, to refresh and moisturize the skin. Can be used for instant hydration, as a toner, or as a primer before or to set makeup."
    },
    ar: {
      ...
      ingredients: ["ماء الورد (الورد الدمشقي)", "ماء", "جليسرين", "إي دي تي إيه (EDTA)", "فيتامين B3 (نياسيناميد)", "حمض الهيالورونيك", "ماء الأرز"],
      benefits: ["يساعد على تهدئة البشرة الجافة وحب الشباب والطفح الجلدي والبثور، ويمكن استخدامه لجميع أنواع البشرة"],
      usage: "رشّي 2-3 مرات بالتساوي على الوجه والرقبة في أي وقت من اليوم لتنعش البشرة وترطبها. يمكن استخدامه للترطيب الفوري، كتونر، أو كبرايمر قبل المكياج أو لتثبيته."
    }
  },

  {
    ...
    en: {
      ...
      ingredients: ["Aloe Vera Extract (Aloe Barbadensis Leaf Extract)", "Rose Floral Water (Rosa Damascena)", "Pure Lemon & Mint Extracts (Citrus Limon & Mentha Extracts)", "Pure Cucumber Extract (Cucumis Sativus Fruit Extract)", "Pure Neem Hydrosol (Azadirachta Indica)", "Tea Tree Oil (Melaleuca Alternifolia Leaf Oil)", "Rice Water (Oryza Sativa)", "Aqua", "Glycerine (Glycerolum)", "EDTA (Disodium EDTA)", "Vitamin B3 (Niacinamide)"],
      benefits: ["Balances and hydrates mature, dehydrated & dry skin", "Soothes and nourishes depleted or irritated skin", "Tones and protects skin's microbiome", "Tones & gently cleanses skin"],
      usage: "Spray 2-3 times evenly across the face and neck, any time during the day, to refresh and moisturize the skin. Can be used for instant hydration, as a toner, or as a primer before or to set makeup."
    },
    ar: {
      ...
      ingredients: ["مستخلص الألوفيرا", "ماء الورد (الورد الدمشقي)", "مستخلصا الليمون والنعناع النقيان", "مستخلص الخيار النقي", "مقطر النيم النقي", "زيت شجرة الشاي", "ماء الأرز", "ماء", "جليسرين", "إي دي تي إيه (EDTA)", "فيتامين B3 (نياسيناميد)"],
      benefits: ["يوازن ويرطّب البشرة الناضجة أو الجافة أو المفتقدة للرطوبة", "يهدئ ويغذّي البشرة المرهقة أو المتهيجة", "ينظم ويحمي ميكروبيوم البشرة", "ينعش وينظف البشرة بلطف"],
      usage: "رشّي 2-3 مرات بالتساوي على الوجه والرقبة في أي وقت من اليوم لتنعش البشرة وترطبها. يمكن استخدامه للترطيب الفوري، كتونر، أو كبرايمر قبل المكياج أو لتثبيته."
    }
  },
     ...
     --------------------------------------------------------- */
  {
    ...
    en: {
      ...
      benefits: ["Moisturizes dry, sensitive, or flaky skin", "Fades dark circles and soothes puffiness around the eyes", "Strengthens hair from root to tip and adds a silky shine", "Treats dandruff and calms an itchy scalp", "Acts as a natural makeup remover and skin barrier enhancer"],
    ...
    ar: {
      ...
      ingredients: ["زيت اللوز الحلو المعصور على البارد 100%"],
      benefits: ["يرطّب البشرة الجافة أو الحساسة أو المتقشرة", "يقلل الهالات الداكنة ويهدئ الانتفاخ حول العينين", "يقوّي الشعر من الجذور إلى الأطراف ويمنحه لمعانًا حريريًا", "يعالج القشرة ويهدئ فروة الرأس المثيرة للحكة", "يعمل كمزيل طبيعي للمكياج ويعزز حاجز البشرة"],
...

  {
    ...
    en: {
      ...
      benefits: ["Hydrates and smoothes skin without leaving a residue", "Reduces fine lines and signs of aging", "Promotes soft, manageable hair", "Acts as a soothing carrier oil for essential oils", "Helps calm inflamed or sun-damaged skin", "Full of Vitamin C & E"],
    ...
    ar: {
      ...
      benefits: ["يرطّب وينعّم البشرة دون ترك أي أثر دهني", "يقلل الخطوط الدقيقة وعلامات التقدم في السن", "يمنح الشعر نعومة وسهولة في التصفيف", "يعمل كزيت ناقل مهدئ للزيوت العطرية", "يساعد على تهدئة البشرة الملتهبة أو المتضررة من الشمس", "غني بفيتاميني C وE"],
...

  {
    ...
    en: {
      ...
      ingredients: ["100% Cold Pressed Nigella Sativa (Black Seed) Oil"],
      benefits: ["Fights acne, eczema, and skin irritation", "Promotes hair growth and combats premature greying", "Boosts immunity when taken orally in moderation", "Helps reduce joint inflammation and muscle aches", "Balances scalp health and soothes itchiness", "Full of Vitamin C & E"],
    ...
    ar: {
      ...
      ingredients: ["زيت حبة البركة (الكلونجي) المعصور على البارد 100%"],
      benefits: ["يحارب حب الشباب والإكزيما وتهيج البشرة", "يعزز نمو الشعر ويقاوم الشيب المبكر", "يقوّي المناعة عند تناوله بالفم باعتدال", "يساعد على تخفيف التهاب المفاصل وآلام العضلات", "يوازن صحة فروة الرأس ويهدئ الحكة", "غني بفيتاميني C وE"],
...

  {
    ...
    en: {
      ...
      benefits: ["Deeply hydrates and firms the skin", "Enhances scalp circulation and reduces hair fall", "Alleviates joint and muscle pain when used in massage", "Protects skin from pollution and sun damage", "Contains natural antibacterial properties", "Full of Vitamin E & Antioxidants"],
    ...
    ar: {
      ...
      ingredients: ["زيت السمسم المعصور على البارد 100%"],
      benefits: ["يرطّب البشرة بعمق ويشدّها", "يعزز الدورة الدموية في فروة الرأس ويقلل تساقط الشعر", "يخفّف آلام المفاصل والعضلات عند استخدامه في التدليك", "يحمي البشرة من التلوث وأضرار الشمس", "يحتوي على خصائص طبيعية مضادة للبكتيريا", "غني بفيتامين E ومضادات الأكسدة"],
     ...
     --------------------------------------------------------- */
  {
    ...
    en: {
      ...
      ingredients: ["Blend of 17 Herbs (specific herbs not disclosed by manufacturer)"],
      benefits: [],
    ...
    ar: {
      ...
      ingredients: ["مزيج من 17 عشبة (الشركة المصنّعة لم تفصح عن أسمائها)"],
      benefits: [],
...

  {
    ...
    en: {
      ...
      ingredients: ["100% Amla (Indian Gooseberry) Oil"],
      benefits: ["Strengthens hair from the roots and reduces breakage", "Promotes thicker, longer hair growth and slows premature greying", "Adds shine and smoothness to dull, damaged strands", "Helps eliminate dandruff and soothes itchy scalp", "Cools the scalp and supports overall scalp health"],
    ...
    ar: {
      ...
      ingredients: ["زيت الأملا (عنب الثعلب الهندي) 100%"],
      benefits: ["يقوّي الشعر من جذوره ويقلل تكسّره", "يعزز نمو شعر أكثر كثافة وطولًا ويبطئ الشيب المبكر", "يمنح الخصلات الباهتة والمتضررة لمعانًا ونعومة", "يساعد على القضاء على القشرة ويهدئ فروة الرأس المثيرة للحكة", "يبرّد فروة الرأس ويدعم صحتها العامة"],
     ...
     --------------------------------------------------------- */
  {
    ...
    en: {
      ...
      ingredients: [],
      benefits: ["Promotes even skin tone and a natural glow", "Moisturizes and smooths rough patches", "Calms sensitivity and adds a gentle floral aroma", "Suitable for all skin types, including dry and mature skin"],
    ...
    ar: {
      ...
      ingredients: [],
      benefits: ["يعزز توحيد لون البشرة وإشراقها الطبيعية", "يرطّب وينعّم المناطق الخشنة", "يهدئ الحساسية ويضيف رائحة زهرية لطيفة", "مناسب لجميع أنواع البشرة، بما في ذلك الجافة والناضجة"],
...

  {
    ...
    en: {
      ...
      ingredients: [],
      benefits: ["Calms inflammation, redness, and rashes", "Provides soothing hydration without greasiness", "Helps heal minor cuts or post-waxing irritation", "Great for sensitive skin or after-sun care"],
      usage: "Wet the bar, lather between wet hands, and massage onto skin. Rinse thoroughly with water."
    },
    ar: {
      ...
      ingredients: [],
      benefits: ["يهدئ الالتهاب والاحمرار والطفح الجلدي", "يوفر ترطيبًا مهدئًا دون دهنية", "يساعد على التئام الجروح البسيطة أو تهيج ما بعد إزالة الشعر", "رائع للبشرة الحساسة أو العناية بعد التعرض للشمس"],
      usage: "بلّلي القالب ورغّيه بين يدين مبلّلتين، ثم دلّكي به البشرة واشطفيه جيدًا بالماء."
    }
  },

  {
    ...
    en: {
      ...
      ingredients: [],
      benefits: ["Removes dirt, oil, and environmental pollutants", "Reduces blackheads and unclogs pores", "Balances oily and combination skin", "Ideal for oily or acne-prone skin types"],
      usage: "Wet the bar, lather between wet hands, and massage onto skin. Rinse thoroughly with water."
    },
    ar: {
      name: "صابون الفحم",
      ...
      ingredients: [],
      benefits: ["يزيل الأوساخ والزيوت والملوثات البيئية", "يقلل الرؤوس السوداء وينظف المسام المسدودة", "يوازن البشرة الدهنية والمختلطة", "مثالي لأنواع البشرة الدهنية أو المعرضة لحب الشباب"],
      usage: "بلّلي القالب ورغّيه بين يدين مبلّلتين، ثم دلّكي به البشرة واشطفيه جيدًا بالماء."
    }
  },

  {
    ...
    en: {
      ...
      ingredients: [],
      benefits: ["Deeply moisturizes dry, sensitive, or irritated skin", "Helps fight acne, inflammation, and clogged pores", "Soothes eczema, redness, and itchiness", "Maintains skin's pH while gently cleansing", "Suitable for both face and body"],
      usage: "Wet the bar, lather between wet hands, and massage onto skin. Rinse thoroughly with water."
    },
    ar: {
      ...
      ingredients: [],
      benefits: ["يرطّب بعمق البشرة الجافة أو الحساسة أو المتهيجة", "يساعد على مكافحة حب الشباب والالتهاب والمسام المسدودة", "يهدئ الإكزيما والاحمرار والحكة", "يحافظ على توازن درجة حموضة البشرة مع تنظيف لطيف", "مناسب للوجه والجسم معًا"],
      usage: "بلّلي القالب ورغّيه بين يدين مبلّلتين، ثم دلّكي به البشرة واشطفيه جيدًا بالماء."
    }
  },

  {
    ...
    en: {
      ...
      ingredients: [],
      benefits: ["Gently removes dead skin cells without stripping moisture", "Deeply hydrates and soothes irritated or flaky skin", "Natural antibacterial properties help cleanse pores", "Suitable for daily face and body use"],
    ...
    ar: {
      ...
      ingredients: [],
      benefits: ["يزيل خلايا الجلد الميتة بلطف دون سلب الرطوبة", "يرطّب ويهدئ بعمق البشرة المتهيجة أو المتقشرة", "خصائصه الطبيعية المضادة للبكتيريا تساعد على تنظيف المسام", "مناسب للاستخدام اليومي للوجه والجسم"],
